...
check if they are balanced or not. Brackets are said to be balanced if the bracket which opens last,
closes first.
...
doesn't have its corresponding closing bracket which makes it imbalanced and in turn, making the whole expression
